            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    @if ($postulaciones->isEmpty())
                        <div class="rounded-md border border-gray-200 p-6 text-gray-700 flex items-center justify-between">
                            <span>Aún no tienes postulaciones registradas.</span>
                                        ...
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-4 py-3 text-sm text-right space-x-3">
                                                <a class="text-indigo-600 hover:text-indigo-900"
                                                   href="{{ route('student.postulaciones.show', $postulacion) }}">
                                                    Ver
                                                </a>

                                                @if (($postulacion->estado ?? '') === 'Pendiente')
                                                    <a class="text-gray-700 hover:text-gray-900"
                                                       href="{{ route('student.postulaciones.edit', $postulacion) }}">
                                                        Editar
                                                    </a>
                                                @endif
                                            </td>

<x-app-kits-layout>
        ...
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Editar registro – {{ $registro->nino_nombre }}
            </h2>

            <a href="{{ route('kits.registros.show', $registro) }}" class="text-sm text-gray-600 hover:text-gray-900">
                Cancelar
            </a>
        </div>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-4 rounded-md bg-gray-50 p-4 text-sm text-gray-700">
                        Puedes editar mientras el estado esté en <strong>Pendiente</strong>.
                    </div>

                    <form method="POST"
                          action="{{ route('kits.registros.update', $registro) }}"
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <input name="nino_nombre" type="text"
                                       ...
                                       value="{{ old('nino_nombre', $registro->nino_nombre) }}" required>
                            </div>
                            ...
                            <div>
                                ...
                                <input name="nino_documento" type="text"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                       value="{{ old('nino_documento', $registro->nino_documento) }}">
                            </div>
                            ...
                            <div>
                                ...
                                <input name="nino_fecha_nacimiento" type="date"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                       value="{{ old('nino_fecha_nacimiento', optional($registro->nino_fecha_nacimiento)->format('Y-m-d')) }}">
                            </div>
                            ...
                            <div>
                                ...
                                <input name="grado" type="text"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                       value="{{ old('grado', $registro->grado) }}">
                            </div>
                        </div>
                        ...
                        <div class="mt-6 space-y-4">
                            <div>
                                ...
                                @if ($registro->pdf_documento)
                                    <p class="mt-1 text-xs text-gray-500">
                                        Ya hay un archivo cargado: <span class="font-medium">{{ basename($registro->pdf_documento) }}</span>
                                    </p>
                                @endif
                            </div>
                            ...
                            <div>
                                ...
                                @if ($registro->pdf_certificado)
                                    <p class="mt-1 text-xs text-gray-500">
                                        Ya hay un archivo cargado: <span class="font-medium">{{ basename($registro->pdf_certificado) }}</span>
                                    </p>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="mt-6 flex items-center justify-end gap-3">
                            <a href="{{ route('kits.registros.show', $registro) }}"
